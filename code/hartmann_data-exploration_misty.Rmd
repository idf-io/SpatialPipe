...
#
save.image("output-data/hartmann/hartmann_misty_data-exploration.Rdata")
load("output-data/hartmann/hartmann_misty_data-exploration.Rdata")
...
saveRDS(misty.results, file = "output-data/hartmann/misty_intra-para/hartmann_misty_intra-para_point8.Rds")
misty.results <- readRDS("output-data/hartmann/misty_intra-para/hartmann_misty_intra-para_point8.Rds")
